...
excerpt: 'In this research, we propose a novel approach to enhancing the U-Net architecture for medical image segmentation. By integrating Weighted Inception Module and Adaptive Distributed Attention Mechanism, our proposed Dynamic U-Net achieves superior segmentation accuracy and computational efficiency compared to traditional U-Net variants.'
date: 2024-10-10
